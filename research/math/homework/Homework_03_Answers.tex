...
(b) 考虑群 $P := \left\{\begin{pmatrix} a & b \\ 0 & 1 \end{pmatrix} \in GL_2(\mathbb{R})\right\}$。将 $P$ 视为嵌入 $\mathbb{R}^2$ 的流形。通过 $\mathbb{R}^2$ 的任意偏好坐标，写出 $P$ 上左不变向量场的一组基。它们也是右不变的吗？
...
$\int_0^{\pi/2} \sin(2\theta) d\theta = \left[-\frac{1}{2}\cos(2\theta)\right]_0^{\pi/2} = \frac{1}{2} - \left(-\frac{1}{2}\right) = 1$。\\
